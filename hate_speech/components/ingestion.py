...
from hate_speech.configuration.configs import DataIngestionConfig
...
class DataIngestion:
    ...
    def unzip_and_clean(self):
        logging.info("---------- STAGE [unzip_and_clean] STARTED ---------- /n")
        try:
            with ZipFile(self.data_ingestion_config.ZIP_FILE_PATH, 'r') as zip_ref:
                zip_ref.extractall(self.data_ingestion_config.ZIP_FILE_DIR)
            
            logging.info("---------- STAGE [unzip_and_clean] COMPLETED ---------- /n")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifacts:
        ...
        logging.info("STAGE [Data Ingestion] STARTED ----------/n")
        try:
            ...
            logging.info("STAGE [Data Ingestion] COMPLETED ----------/n")
